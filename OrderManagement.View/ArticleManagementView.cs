...
namespace OrderManagement.View
{
    public partial class ArticleManagementView : Form
    {
        ...
        private void SetArticleGridColumns()
        {
            ...
            var colPrice = new DataGridViewTextBoxColumn { HeaderText = "Preis in CHF", Name = "price", DataPropertyName = "price", DefaultCellStyle = { Format = "N2" } };
            var colMwst = new DataGridViewTextBoxColumn { HeaderText = "Mwst in %", Name = "mwst", DataPropertyName = "mwst", DefaultCellStyle = { Format = "N2" } };
